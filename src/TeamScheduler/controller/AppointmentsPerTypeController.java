 ...
 * @author james.clair
 */
public class AppointmentsPerTypeController implements Initializable {
	Stage stage;
	Parent scene;	
	...
	@FXML
	private TableView<ApptType> apptPerTypeTableView;
	@FXML
	private TableColumn<CustomerAppt, String> apptTypeCol;
	@FXML
	...
	public void initialize(URL url, ResourceBundle rb) {
		try {
			apptPerTypeTableView.setItems(AppointmentDao.apptsByType());
			...
			Logger.getLogger(AppointmentsPerTypeController.class.getName()).log(Level.SEVERE, null, ex);
		}
	}	
